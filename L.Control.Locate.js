...
(function (factory, window) {
    ...
    const LocationMarker = L.Marker.extend({
        ...
        _getIconSVG(options, style) {
            ...
            const s = r + w;
            const s2 = s * 2;
            const svg = `<svg xmlns="https://www.w3.org/2000/svg" width="${s2}" height="${s2}" version="1.1" viewBox="-${s} -${s} ${s2} ${s2}">` +
    ...
    const CompassMarker = LocationMarker.extend({
        ...
        _getIconSVG(options, style) {
            ...
            const svg = `<svg xmlns="https://www.w3.org/2000/svg" width="${w}" height="${h}" version="1.1" viewBox="-${w/2} 0 ${w} ${h}" style="${svgstyle}">`+
